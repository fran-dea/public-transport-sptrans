...
# =========================
passageiros_historico_pivot = pd.read_parquet("https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/passageiros_historico_pivot.parquet").reset_index()
# passageiros_historico_frequencia_ideal = pd.read_parquet("dados/passageiros_historico_frequencia_ideal.parquet")
rotas_historico_categorizado = pd.read_parquet("https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/rotas_historico_categorizado.parquet").drop_duplicates(subset='route_id')
routes_dist_km_historico = pd.read_parquet("https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/routes_dist_km_historico.parquet")
routes_dist_km_percorridos_historico = pd.read_parquet("https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/routes_dist_km_percorridos_historico.parquet")
frequencias_historico = pd.read_parquet(r"https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/frequencies_historico_categorizado.parquet")
frequencia_ideal = pd.read_parquet(r"https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/passageiros_historico_frequencia_ideal.parquet")[['data', 'route_id',
...
max_trip=pd.read_parquet(r"https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/trips_more_recent.parquet")[['route_id','direction_id','stop_id','stop_sequence','stop_name','stop_desc']]
...
def atualizar_dashboard(route_id):
    ...
    path_hist = f"https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/rota_{route_id}_historico.html"
    path_mais_recente=f"https://huggingface.co/datasets/Franboesazz/public-transport-sp/resolve/main/rota_{route_id}_com_gdf.html"
