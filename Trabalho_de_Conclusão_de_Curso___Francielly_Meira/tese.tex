...
\title{Modelagem Matemática da Rede de Transporte Público de São Paulo}[Uma análise da Rede de Ônibus Operada pela SPTrans]
\translatedtitle{Mathematical Modeling of the Public Transportation Network of São Paulo}[An Analysis of the Bus Network Operated by SPTrans]

\author[fem]{Francielly Cristina Pogogelski Meira}

\def\profa{Prof\kern.02em.\kern-.07emª\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11emª\kern.07em}

% Para TCCs, este comando define o supervisor
\orientador[fem]{\profa{} \dra{} Daielly Melina Nassif Mantovani}
...
\epigrafe{March comes in like a lion, and goes out like a lamb.}{}

Agradeço profundamente ao meu pai, que desde cedo me ensinou o valor do estudo e do conhecimento, e a minha mãe, por todo o apoio incondicional.
...
\pagestyle{mainmatter}
\input{conteudo/01-literatura}
\input{conteudo/02-metodologia}
% \input{conteudo/03-cronograma}
